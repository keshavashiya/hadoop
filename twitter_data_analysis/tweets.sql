...
STORED AS TEXTFILE
LOCATION '/hadoop/dictionary';

-- loading data to the table dictionary
load data inpath '/hadoop/dictionary/dictionary.tsv' INTO TABLE dictionary;
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' 
STORED AS TEXTFILE
LOCATION '/hadoop/time_zone_map';

-- loading data to the table time_zone_map
load data inpath '/hadoop/time_zone_map/time_zone_map.tsv' INTO TABLE time_zone_map;
